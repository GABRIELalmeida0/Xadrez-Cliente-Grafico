...
class Rook():
    def __init__(self,screen, color):
        self.rook = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Torre.png"),(60,60))
        self.color = color
        self.screen = screen
...
class Bishop():
    def __init__(self,screen, color):
        self.bishop = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Bispo.png").convert_alpha(),(60,60))
        self.screen = screen
        self.color = color
        self.posX = self.posY = None
        self.rect = None
...
class King():
    def __init__(self,screen, color):
        self.king = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Rei.png").convert_alpha(),(60,60))
        self.screen = screen
        self.color = color
        self.posX = self.posY = None
        self.rect = None
...
class Queen():
    def __init__(self,screen, color):
        self.queen = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Rainha.png").convert_alpha(),(60,60))
        self.screen = screen
        self.color = color
        self.posX = self.posY = None
        self.rect = None
...
class Pawn():
    def __init__(self,screen, color):
        self.pawn = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Peao.png").convert_alpha(),(60,60))
        self.screen = screen
        self.color = color
        self.posX = self.posY = None
        self.rect = None
...
class Knigth():
    def __init__(self,screen, color):
        self.knigth = pygame.transform.scale(pygame.image.load(f"imagens/pecas/{color}/Cavalo.png").convert_alpha(),(60,60))
        self.screen = screen
        self.color = color
        self.posX = self.posY = None
        self.rect = None
