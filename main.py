...
import pygame
from pecas import King,Queen,Bishop,Knigth,Rook,Pawn
from tabuleiro_v1 import Tabuleiro
...
def main():
    ...
    icon = pygame.image.load("imagens/logo_chess.png")
    pygame.display.set_icon(icon)   
    
    #create a Board
    board = Tabuleiro(heigth,weigth,screen=screen)
    # add pieces in the board
    board.add_pieces("white",screen,(King,Queen,Bishop,Knigth,Rook,Pawn))
    ...
    while running:
        ...
        [obj.update(event_list) for obj in board.enemy_piece.values()]
